...
pub type OwnedGreetRequestView = ::buffa::view::OwnedView<
    crate::proto::soulrust::greet::v1::__buffa::view::GreetRequestView<'static>,
>;
///Shorthand for `OwnedView<GreetResponseView<'static>>`.
pub type OwnedGreetResponseView = ::buffa::view::OwnedView<
    crate::proto::soulrust::greet::v1::__buffa::view::GreetResponseView<'static>,
>;
impl ::connectrpc::Encodable<crate::proto::soulrust::greet::v1::GreetResponse>
for crate::proto::soulrust::greet::v1::__buffa::view::GreetResponseView<'_> {
    fn encode(
        &self,
...
pub const GREET_SERVICE_SERVICE_NAME: &str = "soulrust.greet.v1.GreetService";
...
pub const GREET_SERVICE_GREET_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
        "/soulrust.greet.v1.GreetService/Greet",
        ::connectrpc::StreamType::Unary,
    )
    .with_idempotency_level(::connectrpc::IdempotencyLevel::Unknown);
/// Server trait for GreetService.
///
...
pub trait GreetService: Send + Sync + 'static {
    ...
    fn greet<'a>(
        ...
        request: ::connectrpc::ServiceRequest<
            '_,
            crate::proto::soulrust::greet::v1::GreetRequest,
        >,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
                crate::proto::soulrust::greet::v1::GreetResponse,
            > + Send + use<'a, Self>,
        >,
    > + Send;
}
                ...
                "Greet",
                {
                    ...
                    ::connectrpc::view_handler_fn(move |
                        ...
                        req: ::buffa::view::OwnedView<
                            crate::proto::soulrust::greet::v1::__buffa::view::GreetRequestView<
                                'static,
                            >,
                        >,
                        format|
...
impl<T: GreetService> ::connectrpc::Dispatcher for GreetServiceServer<T> {
    ...
    fn lookup(
        ...
        let method = path.strip_prefix("soulrust.greet.v1.GreetService/")?;
        match method {
            "Greet" => {
                Some(
    ...
    fn call_unary(
        ...
        let Some(method) = path.strip_prefix("soulrust.greet.v1.GreetService/") else {
        ...
        match method {
            "Greet" => {
                ...
                Box::pin(async move {
                    ...
                    let req: crate::proto::soulrust::greet::v1::__buffa::view::GreetRequestView<
                        '_,
    ...
    <T::ResponseBody as ::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the Greet RPC. Sends a request to /soulrust.greet.v1.GreetService/Greet.
    pub async fn greet(
        &self,
        request: crate::proto::soulrust::greet::v1::GreetRequest,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::proto::soulrust::greet::v1::__buffa::view::GreetResponseView<
                    'static,
                >,
            >,
        >,
